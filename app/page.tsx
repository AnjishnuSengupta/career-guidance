...
export default function Home() {
  ...
  const universities = [
    ...
    },
    {
      ...
      scholarships: "Merit scholarships and financial aid available",
    },
    {
      name: "BITS Pilani",
      image:
  ...
  useEffect(() => {
    ...
    if (!isPaused) {
      interval = setInterval(() => {
        setCurrentUniversityIndex((prev) =>
          prev === universities.length - 1 ? 0 : prev + 1
        );
      }, 5000);
    }
  ...
  const streams = [
    {
      title: "Science",
      description:
        "The foundation for careers in technology, healthcare, and research",
      subjects: ["Physics", "Chemistry", "Biology", "Mathematics"],
      careers: ["Engineering", "Medicine", "Research", "IT"],
      opportunities:
        "High demand in tech, healthcare, and research sectors globally",
    },
    {
      title: "Commerce",
      ...
      opportunities:
        "Excellent prospects in corporate, finance, and entrepreneurial ventures",
    },
    {
      title: "Humanities",
      ...
      opportunities:
        "Growing demand in education, media, legal, and social sectors",
    },
  ];
  ...
  const courses = [
    {
      ...
      stream: "Science",
      scope:
        "High demand across industries, especially in IT, manufacturing, and infrastructure",
      jobs: [
        "Software Engineer",
        "Product Manager",
        "Systems Analyst",
    ...
    },
    {
      ...
      stream: "Humanities",
      scope:
        "Growing field with applications in healthcare, education, and corporate sectors",
      jobs: [
        "Counselor",
        "HR Specialist",
        "Research Assistant",
  ...
  const resources = [
    {
      ...
      description:
        "Comprehensive information about JEE, NEET, CLAT, CAT, and other entrance exams",
      link: "#",
    },
    {
      title: "Top 50 Colleges in India",
      description:
        "Detailed rankings and information about the best colleges across streams",
      link: "#",
    },
    {
      title: "Scholarship Opportunities",
      description:
        "List of scholarships available for undergraduate and postgraduate students",
      link: "#",
    },
    {
  ...
  const chatMessages = [
    {
      ...
      name: "Dr. Sharma",
      message:
        "Hello! I'm Dr. Sharma, a career counselor with 15 years of experience. How can I help you today?",
      time: "10:30 AM",
    },
    {
      sender: "Student",
        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0 md:pr-8">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Helping you choose the right stream, career and college.
            </p>
            <Button
              onClick={() => {
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="bg-purple-50 p-6 rounded-lg">
            ...
            <p className="text-gray-600">
              Find the perfect academic stream that aligns with your interests,
          ...
          <div className="bg-blue-50 p-6 rounded-lg">
            ...
            <p className="text-gray-600">
              Browse through top universities and colleges that offer programs
          ...
          <div className="bg-green-50 p-6 rounded-lg">
            ...
            <p className="text-gray-600">
              Explore various career paths and understand the steps needed to
        ...
        {!quizStarted ? (
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Discover which stream and career path might be the best fit for
              you based on your interests, skills, and preferences.
            </p>
            <Button
            ...
            {courses
              .filter(
                (course) =>
                  ...
                  course.stream.includes("Commerce")
              )
              .map((course, index) => (
                <Card key={index}>
                  <CardHeader>
      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Get advice from experienced mentors and university representatives
            </CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <div className="bg-purple-600 h-32 md:h-48 relative">
            <div className="absolute -bottom-16 left-8">
              <Avatar className="h-32 w-32 border-4 border-white">
                <AvatarFallback className="text-4xl bg-purple-200 text-purple-600">
                  RS
                </AvatarFallback>
              </Avatar>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <Card className="md:col-span-2">
                <CardHeader>
                  ...
                  <CardDescription>
                    Based on your quiz results and academic performance
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div className="border border-gray-200 rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-600 mb-3">
                        Your strong performance in Mathematics and interest in
                        problem-solving make this a great fit.
                      </p>
                    ...
                    <div className="border border-gray-200 rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-600 mb-3">
                        Your analytical skills and mathematics aptitude align
                        well with this growing field.
                      </p>
                      <Badge className="bg-green-100 text-green-800">
                        90% Match
                      </Badge>
                    ...
                    <div className="border border-gray-200 rounded-lg p-4">
                      ...
                      <p className="text-sm text-gray-600 mb-3">
                        Your problem-solving abilities and science background
                        make this an exciting option.
                      </p>
  ...
  // Update the Quiz Result display (around line 1385)
    ...
    <div className="p-8 bg-white rounded-lg shadow-lg max-w-3xl mx-auto">
      ...
      <div className="mb-8">
        <h4 className="text-xl font-semibold mb-2">
          Recommended Stream:{" "}
          <span className="text-purple-600">{quizResult?.stream}</span>
        </h4>
      ...
      {/* Add this section to show videos */}
      <div className="mt-8">
        <h4 className="text-xl font-semibold mb-4">
          Recommended Videos for {quizResult?.stream}
        </h4>
        {isLoadingVideos ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {courseVideos.slice(0, 4).map((video) => (
              <div
                key={video.id}
        ...
        <div className="text-center mt-6">
          <Button
            onClick={() => {
              ...
              // Scroll to course videos section
              document
                .getElementById("course-videos")
                ?.scrollIntoView({ behavior: "smooth" });
            }}
            className="bg-purple-600 hover:bg-purple-700"
          >
            Explore More Educational Videos
          </Button>
        </div>
      </div>
  ...
  const CourseVideosSection = () => (
    <section id="course-videos" className="py-16 px-4 bg-gray-50">
      <div className="container mx-auto">
        <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">
